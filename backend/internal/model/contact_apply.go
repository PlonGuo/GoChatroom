...
type ContactApply struct {
	...
	UserID      string         `gorm:"type:char(20);not null;index" json:"userId"`      // Applicant
	ContactID   string         `gorm:"type:char(20);not null;index" json:"contactId"`   // Target user or group

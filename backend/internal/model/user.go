...
type User struct {
	...
	Gender        int8           `gorm:"type:tinyint;default:0" json:"gender"` // 0: unspecified, 1: male, 2: female
	Signature     string         `gorm:"type:varchar(200)" json:"signature"`
	Birthday      string         `gorm:"type:char(10)" json:"birthday"` // YYYY-MM-DD format
	IsAdmin       bool           `gorm:"default:false" json:"isAdmin"`
	Status        int8           `gorm:"type:tinyint;default:0;index" json:"status"` // 0: active, 1: disabled
